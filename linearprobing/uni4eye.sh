./runner python3 main/clf_tasks_main.py \
    ...
    --seed 0 1 2 3 4 \
    --init_weights \
        _weights/uni4eye++_vitl.pth \
    --ft_weights \
        _weights/best-model_Uni4eyepp0.07Falselr0.0001batch_size128grad_accum1LossesAll_bscan.pth \
    --linear_probing true \
    --batch_size 0 \
    --nb_classes 0 \
    ...
    --epochs 1000 \
    --version improvement_analysis/fine_tuned/Uni4Eye_pp \
    --fill 0 \
    --data_set \
